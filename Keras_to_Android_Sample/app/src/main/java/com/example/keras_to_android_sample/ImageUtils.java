...
////////////////////////////////////////////////////////////////////////////////////////////////////
    public static float[] normalizeBitmap(Bitmap source,int size,float mean,float std){
        ...
        for (int i = 0; i < intValues.length; ++i) {
            final int val = intValues[i];
            output[i * 3] = (((val >> 16) & 0xFF))/mean;    //右移16位，取最後8位
            output[i * 3 + 1] = (((val >> 8) & 0xFF))/mean; //右移8位，取最後8位
            output[i * 3 + 2] = ((val & 0xFF))/mean;
        }
        //System.out.println("hello world!");
        //System.out.println(intValues.length);
        //System.out.println(intValues[0]);
        //System.out.println(intValues[1000]);
        //System.out.println(intValues[2000]);
        return output;
